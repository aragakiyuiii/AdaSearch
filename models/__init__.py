...
class ImagenetRunConfig(RunConfig):
    ...
    def __init__(self, dataset_location=None, n_epochs=75, init_lr=0.05, lr_schedule_type='cosine', lr_schedule_param=None,
        ...
        super(ImagenetRunConfig, self).__init__(
            dataset_location, n_epochs, init_lr, lr_schedule_type, lr_schedule_param,
